# Time Billing for Claude Code: operating instructions
...
- `docs/` the thesis and the guide for moving off Harvest.

Built by Enterprise DNA. Installed and run for you as part of Omni: https://enterprisedna.co/omni/instead-of/harvest
